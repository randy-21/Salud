...
function riskFactorStore() {
    var formData = new FormData(document.getElementById("riskFactor"));
    axios({
            method: 'post',
            url: '../riskFactorStore',
            data: formData,
...
function riskFactorImportGoogle() {
...
function riskFactorEdit(id) {
    ...
    axios({
        ...
        .then(function(response) {
            riskFactor.id.value = response.data["id"];
            riskFactor.dni.value = response.data["dni"];
            riskFactor.firstname.value = response.data["firstname"];
            riskFactor.lastname.value = response.data["lastname"];
            riskFactor.names.value = response.data["names"];
            riskFactor.cellphone.value = response.data["cellphone"];
            riskFactor.district.value = response.data["district"];
            riskFactor.network.value = response.data["network"];
          
            riskFactor.ipress.value = response.data["ipress"];
            riskFactor.age.value = response.data["age"];
            riskFactor.provenance.value = response.data["provenance"];
            riskFactor.address.value = response.data["address"];
            riskFactor.fur.value = response.data["fur"];
            riskFactor.fpp.value = response.data["fpp"];
            riskFactor.gestation_weeks.value = response.data["gestation_weeks"];
            riskFactor.risk_factor.value = response.data["risk_factor"];
            riskFactor.color.value = response.data["color"];
            riskFactor.date_cite.value = response.data["date_cite"];
            riskFactor.date_part.value = response.data["date_part"];
            riskFactor.anemia.value = response.data["anemia"];
            riskFactor.parity.value = response.data["parity"];
            riskFactor.hemoglobine.value = response.data["hemoglobine"];
            riskFactor.cpn.value = response.data["cpn"];
            riskFactor.observations.value = response.data["observations"];
...
function getColor(selectId, inputId) {
    ...
    const color = selectedValue.split(' - ')[0];
